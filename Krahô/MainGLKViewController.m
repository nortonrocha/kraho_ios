...
const Vertex Vertices[] = {
    ...
    {
        {1, -1, 1},     //Position[]
        {0, 0, 0, 1},   //Color[] -> { 255, 0, 0, 255 } { 0, 0, 0, 255 }
        {1, 0}          //TextCoord[]
    },
    {
        {1, 1, 1},
        {0, 0, 0, 1}, // -> { 0, 255, 0, 255 } { 0, 0, 0, 255 }
        {1, 1}},
    {
        {-1, 1, 1},
        {0, 0, 0, 1}, // -> { 0, 0, 255, 255 } { 0, 0, 0, 255 }
        {0, 1}
    },
    {
        {-1, -1, 1},
        {0, 0, 0, 1}, // -> { 0, 0, 0, 255 } { 0, 0, 0, 255 }
        {0, 0}
    },
    // Back internal
    {
        {1, 1, -1},
        {0, 0, 0, 1}, // -> { 255, 0, 0, 255 } { 0, 0, 0, 255 }
        {0, 1}
    },
    {
        {-1, -1, -1},
...
-(void) touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    NSString *locale = @"Location -> ";
    
    
//    NSLog([locale stringByAppendingString:]);
